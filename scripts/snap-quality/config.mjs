...
export const QUALITY_RULES = {
  ...
  maxCellTransitionErrorMaxReview: 169,
  ...
  maxCellDiagonalTransitionErrorMaxReview: 169,
  highCellMae: 18,
  highCellStdDev: 30,
  ...
  maxMeanRgbDrift: 3,
  maxTileMeanRgbDriftP95: 40,
  minTileMeanRgbSampleCount: 64,
  minTileMeanRgbTileCount: 1,
  maxTileLumaMeanDelta: 12,
  maxTileLumaMeanDeltaP95: 8,
  minTileLumaMeanDeltaTileCount: 1,
  inkCoverageLumaThreshold: 32,
  maxInkCoverageDrift: 0.025,
  minInkCoveragePixelCount: 64,
  maxInkComponentCoverageDrift: 0.02,
  minInkComponentArea: 16,
  minInkComponentAreaRatio: 0.00002,
  minInkComponentPixelCount: 64,
  ...
  shadowCoverageLumaThreshold: 48,
  brightCoverageLumaThreshold: 144,
  maxBrightCoverageDrift: 0.05,
  minBrightCoveragePixelCount: 64,
  maxTileBrightCoverageDriftP95: 0.15,
  minTileBrightCoverageSampleCount: 64,
  minTileBrightCoverageTileCount: 1,
  minChromaMeanForRatio: 8,
  minChromaRatio: 0.9,
  maxChromaRatio: 1.2,
  colorfulCoverageChromaThreshold: 16,
  maxColorfulSpuriousRatio: 0.1,
  minColorfulSpuriousPixelCount: 16,
  maxTileColorfulCoverageDriftP95: 0.25,
  minTileColorfulCoverageSampleCount: 64,
  minTileColorfulCoverageTileCount: 1,
  maxSaturatedCoverageDrift: 0.15,
  minSaturatedCoveragePixelCount: 64,
  maxTileSaturatedCoverageDriftP95: 0.5,
  minTileSaturatedCoverageSampleCount: 64,
  minTileSaturatedCoverageTileCount: 1,
  saturatedCoverageChromaThreshold: 112,
  ...
  minAlphaEdgeTileCount: 1,
  minAlphaEdgeTileRecall: 0.7,
  maxAlphaEdgeTileSpuriousRatio: 0.5,
  minAlphaEdgeTileJaccard: 0.35,
  ...
  maxTileRgbHistogramDriftP95: 0.53,
  minTileRgbHistogramSampleCount: 64,
  minTileRgbHistogramTileCount: 1,
  ...
  minTileContrastRatio: 0.6,
  minTileContrastTileCount: 1,
  minTileChromaRatio: 0.78,
  maxTileChromaRatio: 1.25,
  ...
  maxTileEdgeMagnitudeHistogramDriftP95: 0.3,
  minTileEdgeMagnitudeHistogramSampleCount: 64,
  minTileEdgeMagnitudeHistogramTileCount: 1,
  minEdgeDirectionCount: 64,
  maxEdgeDirectionDrift: 0.7,
  minDirectedEdgeBinCount: 1,
  minDirectedEdgeJaccard: 0.16,
  minDirectedEdgeRecall: 0.25,
  maxDirectedEdgeSpuriousRatio: 0.8,
  minEdgeRecall: 0.88,
