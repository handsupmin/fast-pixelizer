...
function criteriaMarkdown() {
  return [
    ...
    `- Alpha components: review when at least ${QUALITY_RULES.minAlphaComponentCount} visible alpha components, or at least ${QUALITY_RULES.minAlphaSmallComponentCount} small alpha component, change count between source and output.`,
