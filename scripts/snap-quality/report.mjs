...
function criteriaMarkdown() {
  return [
    ...
    `- Exact cell color components: review when exact low-palette inputs with at least ${QUALITY_RULES.minExactCellColorComponentCount} color components change component count, area, bounds, perimeter, or position between source cells and output grid, or when at least ${QUALITY_RULES.minExactSmallCellColorComponentCount} small color component changes count.`,
    ...
    `- Alpha components: review when at least ${QUALITY_RULES.minAlphaComponentCount} visible alpha components change count, area, bounds, perimeter, or position between source and output, or when at least ${QUALITY_RULES.minAlphaSmallComponentCount} small alpha component changes count.`,
