...
function toItem({ dataset, expected, input, metrics, name, original, resized, uniformity }) {
  ...
  return {
    ...
    meanRgbSampleCount: metrics.meanRgbSampleCount,
    meanRgbRDrift: formatNum(metrics.meanRgbRDrift),
    meanRgbGDrift: formatNum(metrics.meanRgbGDrift),
    meanRgbBDrift: formatNum(metrics.meanRgbBDrift),
    meanRgbChannelDrift: formatNum(metrics.meanRgbChannelDrift),
    meanRgbDrift: formatNum(metrics.meanRgbDrift),
    tileMeanRgbDriftMax: formatNum(metrics.tileMeanRgbDriftMax),
    tileMeanRgbDriftP95: formatNum(metrics.tileMeanRgbDriftP95),
    tileMeanRgbDriftTileCount: metrics.tileMeanRgbDriftTileCount,
    ...
    sourceInkPixelCount: metrics.sourceInkPixelCount,
    outputInkPixelCount: metrics.outputInkPixelCount,
    inputInkCoverage: formatNum(metrics.inputInkCoverage),
    outputInkCoverage: formatNum(metrics.outputInkCoverage),
    inkCoverageDrift: formatNum(metrics.inkCoverageDrift),
    inkComponentMinArea: metrics.inkComponentMinArea,
    sourceInkComponentCount: metrics.sourceInkComponentCount,
    outputInkComponentCount: metrics.outputInkComponentCount,
    sourceInkComponentPixelCount: metrics.sourceInkComponentPixelCount,
    outputInkComponentPixelCount: metrics.outputInkComponentPixelCount,
    inputInkComponentCoverage: formatNum(metrics.inputInkComponentCoverage),
    outputInkComponentCoverage: formatNum(metrics.outputInkComponentCoverage),
    inkComponentCoverageDrift: formatNum(metrics.inkComponentCoverageDrift),
    inputInkLargestComponentCoverage: formatNum(metrics.inputInkLargestComponentCoverage),
    outputInkLargestComponentCoverage: formatNum(metrics.outputInkLargestComponentCoverage),
    inkLargestComponentCoverageDrift: formatNum(metrics.inkLargestComponentCoverageDrift),
    sourceShadowPixelCount: metrics.sourceShadowPixelCount,
    outputShadowPixelCount: metrics.outputShadowPixelCount,
    inputShadowCoverage: formatNum(metrics.inputShadowCoverage),
    outputShadowCoverage: formatNum(metrics.outputShadowCoverage),
    shadowCoverageDrift: formatNum(metrics.shadowCoverageDrift),
...
async function buildMetrics(input, expected, snapshots, colorVariety) {
  ...
  return {
    metrics: {
      ...
      meanRgbSampleCount: preserve.meanRgbSampleCount,
      meanRgbRDrift: preserve.meanRgbRDrift,
      meanRgbGDrift: preserve.meanRgbGDrift,
      meanRgbBDrift: preserve.meanRgbBDrift,
      meanRgbChannelDrift: preserve.meanRgbChannelDrift,
      meanRgbDrift: preserve.meanRgbDrift,
      tileMeanRgbDriftMax: preserve.tileMeanRgbDriftMax,
      tileMeanRgbDriftP95: preserve.tileMeanRgbDriftP95,
      tileMeanRgbDriftTileCount: preserve.tileMeanRgbDriftTileCount,
      ...
      sourceInkPixelCount: preserve.sourceInkPixelCount,
      outputInkPixelCount: preserve.outputInkPixelCount,
      inputInkCoverage: preserve.inputInkCoverage,
      outputInkCoverage: preserve.outputInkCoverage,
      inkCoverageDrift: preserve.inkCoverageDrift,
      inkComponentMinArea: preserve.inkComponentMinArea,
      sourceInkComponentCount: preserve.sourceInkComponentCount,
      outputInkComponentCount: preserve.outputInkComponentCount,
      sourceInkComponentPixelCount: preserve.sourceInkComponentPixelCount,
      outputInkComponentPixelCount: preserve.outputInkComponentPixelCount,
      inputInkComponentCoverage: preserve.inputInkComponentCoverage,
      outputInkComponentCoverage: preserve.outputInkComponentCoverage,
      inkComponentCoverageDrift: preserve.inkComponentCoverageDrift,
      inputInkLargestComponentCoverage: preserve.inputInkLargestComponentCoverage,
      outputInkLargestComponentCoverage: preserve.outputInkLargestComponentCoverage,
      inkLargestComponentCoverageDrift: preserve.inkLargestComponentCoverageDrift,
      sourceShadowPixelCount: preserve.sourceShadowPixelCount,
      outputShadowPixelCount: preserve.outputShadowPixelCount,
      inputShadowCoverage: preserve.inputShadowCoverage,
      outputShadowCoverage: preserve.outputShadowCoverage,
      shadowCoverageDrift: preserve.shadowCoverageDrift,
